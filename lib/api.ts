...
export interface ChatRequest {
  ...
  metadata_filters?: Record<string, string[]>;  // Dynamic metadata filters
  date_range_filter?: { from?: Date; to?: Date };  // Date range filtering
  search_query_filter?: string;  // Search query filtering
