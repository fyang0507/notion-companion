"""
Database layer for Schema V3 - Simplified single workspace architecture
...
class DatabaseV3:
    ...
    def vector_search_documents(self, query_embedding: List[float], 
        ...
        try:
            # Use the match_documents function from schema V3
    ...
    def vector_search_chunks(self, query_embedding: List[float], 
        ...
        try:
            # Use the match_chunks function from schema V3
    ...
    def hybrid_search(self, query_embedding: List[float],
        ...
        try:
            # Use the hybrid_search function from schema V3
    ...
    def get_recent_chat_sessions(self, limit: int = 20) -> List[Dict[str, Any]]:
        ...
        try:
            # Use the function from schema V3
...
database_v3 = DatabaseV3()

async def init_db():
    """Initialize the database connection."""
    await database_v3.init()

def get_db() -> DatabaseV3:
